...
public:
    ...
    static SearchEngine *parse_cmd_line(std::string heuristic, std::string landmarks, std::string search, bool dry_run);
    static SearchEngine *parse_cmd_line(std::string heuristic, std::string search, bool dry_run);
    static SearchEngine *parse_cmd_line(std::string search, bool dry_run);
