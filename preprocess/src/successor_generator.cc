...
public:
    ...
    virtual void generate_cpp_input(ostringstream &outfile) const = 0;
};
...
public:
    ...
    virtual void generate_cpp_input(ostringstream &outfile) const;
};
...
void GeneratorSwitch::generate_cpp_input(ostringstream &outfile) const {
...
void GeneratorLeaf::generate_cpp_input(ostringstream &outfile) const {
...
void GeneratorEmpty::generate_cpp_input(ostringstream &outfile) const {
...
void SuccessorGenerator::generate_cpp_input(ostringstream &outfile) const {
